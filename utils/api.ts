...
export const dayApi = {
  ...
  create: async (data: {
    ...
    return apiPost<Day>("/api/days", data);
  },
  ...
  update: async (
    ...
    return apiPut<Day>(`/api/days/${id}`, data);
  },
};
...
export const reminderApi = {
   ...
   */
  getByDayId: async (dayId: string): Promise<Reminder[]> => {
    return apiGet<Reminder[]>(`/api/reminders/day/${dayId}`);
  },
  ...
  complete: async (id: string): Promise<Reminder> => {
    return apiPut<Reminder>(`/api/reminders/${id}/complete`, {});
  },
  ...
  delete: async (id: string): Promise<{ success: boolean }> => {
    return apiDelete<{ success: boolean }>(`/api/reminders/${id}`);
  },
};
